...
class OAuthRequiresHandler(sunbeam_rhandlers.RelationHandler):
    ...
    def _oauth_relation_changed(self, event):
        ...
        client_config = ClientConfig(
            self.charm.oidc_redirect_uri, OAUTH_SCOPES, OAUTH_GRANT_TYPES
        )
...
class ExternalIDPRequiresHandler(sunbeam_rhandlers.RelationHandler):
